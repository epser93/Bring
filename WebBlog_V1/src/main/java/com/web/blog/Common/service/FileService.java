...
import com.web.blog.Common.advice.exception.CFileDownloadException;
import com.web.blog.Common.advice.exception.CFileUploadException;
import com.web.blog.Common.config.FileUploadProperties;
import com.web.blog.Common.entity.UploadFile;
import com.web.blog.Common.repository.FileRepository;
...
public class FileService {
    ...
    public Iterable<UploadFile> getFileList() {
        ...
        if (null == iterable) {
            throw new CFileDownloadException("업로드 된 파일이 존재하지 않습니다.");
        }
    ...
    public Optional<UploadFile> getUploadFile(long id) {
        ...
        if (null == uploadFile) {
            throw new CFileDownloadException("해당 아이디[" + id + "]로 업로드 된 파일이 존재하지 않습니다.");
        }
        return uploadFile;
    }
